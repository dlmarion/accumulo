...
public class TabletMetadata {
  ...
  private boolean assignWhenOnDemand = false;
  ...
  public boolean getAssignWhenOnDemand() {
    ensureFetched(ColumnType.ASSIGN_WHEN_ON_DEMAND);
    return assignWhenOnDemand;
  }
